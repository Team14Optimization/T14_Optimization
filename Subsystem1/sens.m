...
subplot(1,3,1)  
scatter(dc,sfs(:,1))
ylabel('Obective 1 value [oC]')
xlabel('Density of casing [kg/m3]')
subplot(1,3,2)
scatter(k,sfs(:,2))
xlabel('Thermal conductivity [W/moC]')
subplot(1,3,3)
scatter(Cc,sfs(:,3))
xlabel('Specific heat capacity [J/kgoC]')
sgtitle('Parameter study of objective 1')
